...
class Packet(BaseModel):
    ...
    picture = models.ImageField(blank=True,  null=True) # need at most 3 picture TODO
    ...
    status = models.CharField(max_length=3, choices=PACKET_STATUS, default='در انتظار تایید')
...
class Travel(BaseModel):
    ...
    visit_count = models.PositiveIntegerField(default=0)
    offer_count = models.PositiveIntegerField(default=0)
    status = models.CharField(max_length=3, choices=TRAVEL_STATUS, default='در انتظار تایید')
